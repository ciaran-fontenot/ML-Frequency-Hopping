...
class Capstone_2621(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.epy_block_2 = epy_block_2.blk(nfft=1024, history_len=128, save_every=500, out_dir="cnn_training_data", samp_rate=4.8e6, chan_spacing=200e3, chan_bw_hz=60e3, num_chans=10, hop_history=64, min_absence_ratio=0.6)
        ...
        self.msg_connect((self.epy_block_2, 'avoid_channels'), (self.epy_block_1, 'avoid_channels'))
