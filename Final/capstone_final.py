...
class capstone_final(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Capstone Prototype", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Capstone Prototype")
        ...
        self.settings = Qt.QSettings("GNU Radio", "capstone_final")
        ...
        self.filter_fft_low_pass_filter_0 = filter.fft_filter_ccc(1, firdes.low_pass(1, samp_rate, 4e3, 100, window.WIN_HAMMING, 6.76), 1)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 1000, 0.3, 0, 0)
        self.analog_frequency_modulator_fc_0 = analog.frequency_modulator_fc((2*3.14159*(5e3)/samp_rate))
        ...
        self.connect((self.blocks_throttle2_0, 0), (self.limesdr_sink_0, 0))
        self.connect((self.filter_fft_low_pass_filter_0, 0), (self.blocks_throttle2_1, 0))
        self.connect((self.limesdr_source_0, 0), (self.filter_fft_low_pass_filter_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.analog_frequency_modulator_fc_0.set_sensitivity((2*3.14159*(5e3)/self.samp_rate))
        self.analog_sig_source_x_0.set_sampling_freq(self.samp_rate)
        self.blocks_throttle2_0.set_sample_rate(self.samp_rate)
        self.blocks_throttle2_1.set_sample_rate(self.samp_rate)
        self.filter_fft_low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 4e3, 100, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=capstone_final, options=None):
